  ...
  if(isError) {
    return (
      <div className="w-[80%] mx-auto mt-8 font-dm-sans">
        <h1 className="text-[var(--text)] transition-colors duration-150 w-full mx-auto text-[26px]">Latest Asian Recipes</h1>
        <div className="text-[var(--text)] transition-colors duration-150 text-2xl font-semibold w-full flex flex-row justify-center items-center h-[200px]">
          {error.message}
        </div>
      </div>
    )
