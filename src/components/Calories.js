    ...
    <div className="text-[var(--text)] lg:text-sm text-base flex flex-col">
      ...
      >
        <div className="flex flex-row items-center gap-3">
          <MdOutlineEnergySavingsLeaf className="h-7 lg:h-6 2xl:h-9 w-auto transition-colors duration-150" />
          <span className="transition-colors duration-150 2xl:text-xl">Calories</span>
          {calories.length ? (
