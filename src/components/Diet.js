    ...
    <div className="text-[var(--text)] lg:text-sm text-base flex flex-col">
      ...
      >
        <div className="flex flex-row items-center gap-4">
          <MdOutlineFastfood style={{ fill: darkMode ? "#ffffff" : "#000000" }} className="transition-colors duration-150 h-7 lg:h-6 w-auto" />
          <span className="transition-colors duration-150">Diet</span>
          {diet.length ? (
